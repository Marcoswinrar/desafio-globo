function accent_fold(a){if(!a)return"";for(var e="",o=0;o<a.length;o++)e+=accent_map[a.charAt(o)]||a.charAt(o);return e.toLowerCase()}var accent_map={"á":"a","à":"a","ã":"a","â":"a","ä":"a","Á":"a","À":"a","Ã":"a","Â":"a","Ä":"a","é":"e","è":"e","ê":"e","ë":"e","É":"e","È":"e","Ê":"e","Ë":"e","í":"i","ì":"i","î":"i","ï":"i","Í":"i","Ì":"i","Î":"i","Ï":"i","ó":"o","ò":"o","õ":"o","ô":"o","ö":"o","Ó":"o","Ò":"o","Õ":"o","Ô":"o","Ö":"o","ú":"u","ù":"u","û":"u","ü":"u","Ú":"u","Ù":"u","Û":"u","Ü":"u","ñ":"n","Ñ":"n","ç":"c","Ç":"c","&":"e","@":"a"};
...
$(document).ready(function(){$("#inputSearch").keyup(function(){var t=accent_fold($(this).val());t.length>=2?(content="",$.ajax({type:"GET",url:"/busca/featureContent/",data:{q:t},async:!1,success:function(t){$.each(t,function(t,s){content+='<li class="feature-content">',content+='<a class="logo" href="'+s.url+'"><img src="'+s.logo+' " ></a> ',content+='<a class="title"  href="'+s.url+'">'+s.title+"</a>",content+="</li>"})}}),$.ajax({type:"GET",url:"/busca/suggests/",data:{q:t},async:!1,success:function(t){t.length>0&&(content+='<li class="suggestions-text">Sugestões de busca</li>'),$.each(t,function(t,s){content+='<li class="suggestion-item"> <a href="http://g1.globo.com/busca/?q='+s+' " >'+s+"</a></li>"})}}),content+='<li class="suggestion-search globo"> <a href="http://g1.globo.com/busca/?q='+t+'"> buscar &#39;<span>'+t+"</span>&#39; na Globo.com › </a></li>",content+='<li class="suggestion-search web"> <a href="https://g1.globo.com/busca/web/q='+t+'"> buscar &#39;<span>'+t+"</span>&#39; na Web › </a></li>",$("#listSuggestions").show(),$("#searchResults").html(content)):$("#listSuggestions").hide()})});